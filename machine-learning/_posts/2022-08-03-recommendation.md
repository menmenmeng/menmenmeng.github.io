...
그럼 다음은? 추천해주기! 행렬에서 **User2**가 Item4에 긍정적인 평점(4점)을 부여한 것을 볼 수 있다. Item3과 Item4가 비슷하다는 가정 하에, 우리는 User2에게 Item3도 추천해줄 수 있을 것이다.
...
![image](https://drive.google.com/uc?export=view&id=1BWAG4hEu1dUnzHMCvlR_wPmaAmyCl_rW)
왼쪽이 유클리드 유사도, 오른쪽이 코사인 유사도{:.figcaption}
