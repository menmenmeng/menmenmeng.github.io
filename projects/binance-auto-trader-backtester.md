...
개발 소스는 BackDataLoader, ConditionGenerator, BackTester로 각각 과거 데이터 로드, 매매 전략 구현, 과거 데이터 및 매매 전략을 활용하여 테스트하는 모듈입니다.
...
[Real-Time Trader](/projects/binance-auto-trader-realtime/){:.heading}
