...
개인적으로, 데이터 분석에 대한 관점을 완전히 바꾸게 된 프로젝트입니다. 복잡한 머신러닝 기법 없이도, 엄청난 코딩 스킬이 없어도 데이터에 관련된 인사이트를 충분히 발굴하고 나아가 경영적으로 도움이 되는 결론을 도출할 수 있음을 깨달았던 프로젝트입니다. 이 프로젝트를 하기 이전의 데이터 분석 업무에는 항상 일정 부분의 의심이 있었습니다. 파이썬의 사이킷런을 
