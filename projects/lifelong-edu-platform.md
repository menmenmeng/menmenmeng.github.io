...
첫 프로젝트였던 만큼 의미가 컸으나 아쉬운 점이 컸던 프로젝트입니다. 가장 큰 아쉬움은, 프로젝트 도중 정부 예산 삭감으로 인해 실제 과제를 이행하지 못하고 이행 방안 설계만 하고 철수했다는 것입니다. 1단계 사업 이후 2단계, 3단계 사업을 거치며 데이터 현황을 정확히 파악하고 실제 서비스로까지 이어질 수 있도록 하는 과정을 full로 경험하지 못했다는 것이 아쉬웠습니다.

반면 기업과 기업 간의 협업 측면에서 배울 점이 많았던 프로젝트이기도 합니다. 무엇을 했는지만큼 중요한 것이, 무엇을 했는지 보여주는 것이었습니다. 프로젝트 초반에 수많은 산출물(프레젠테이션 파일)을 작성하는 이유가 무엇인지에 대한 회의감이 들었지만, 철수 시점에서 기 작성된 산출물들을 검토하면서 기업 간, 팀 간 의사소통에 중요한 역할을 하고 있는 것이 산출물이라는 것을 깨달았습니다. 프로젝트 중 경험한 보안 매뉴얼, 주간 보고 일정, 산출물 주기 등 체계들을 체화하여 향후 다른 프로젝트에서 팀원 간, 팀 간 소통 시 유의미하게 활용할 수 있겠다고 생각했습니다.
