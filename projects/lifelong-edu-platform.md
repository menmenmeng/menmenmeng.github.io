...
프로젝트 도중 정부 예산 삭감으로 인해 실제 과제 수행까지 이어지지 못하고, 이행 방안에 대한 설계까지만 하고 철수하여 아쉬움이 남습니다. 1단계 사업 이후 2단계, 3단계 사업을 거치며 데이터 현황을 정확히 파악하고 실제 서비스로까지 이어질 수 있도록 하는 과정을 full로 경험하지 못했다는 것이 아쉬웠습니다.
