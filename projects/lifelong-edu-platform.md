...
|:------:|:---------|:---------------|:------|:------:|:------:|:------:|:------:|:------:|:------:|
| 강좌 제공 연계 기관 | 1. 늘배움포털 자체 동영상 플레이어를 통해 제공<br>2. 타 사이트의 강좌 링크를 제공<br>3. 링크를 제공하나, 늘배움포털 외의 로그인 아이디가 필요한 경우 등 | 1. 실제 강의 시간으로 표기됨<br>2. 표기되지 않음<br>3. 학습시간이 표기되나 0분으로 표기됨 | 1. 실제 강의 진도율이 표기됨<br>2. 표기되지 않음<br>3. 진도율이 표기되나 항상 0%로 표기됨 | 필수 필드 | 필수 필드 | 필수 필드 | 필수 필드 | 필수 필드 | 하단 세부 내용 정리 |
