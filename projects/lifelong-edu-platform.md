...
| 운영 기관 | 동영상 제공 방식 | 학습시간 표기 | *학습이력 표기* | *강좌명* | *학습분류* | *학습목적* | 강좌이미지 | 강사명 | *강좌 내용* | 
|:------:|:---------|:---------------|:------|:------:|:------:|:------:|:------:|:------:|:------:|
...
학습이력 외에 조금 더 암시적인 Feedback으로서, 연계기관과 관계없이 모든 강좌에 대해 학습자가 학습 강좌를 클릭했는지 여부 또한 학습자마다 식별되고 있었습니다.
