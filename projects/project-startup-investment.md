...
또한, 7개의 X변수를 활용한 FA 및 Clustering을 통해 기업을 5개의 그룹으로 분류하였으며, 분류 결과를 X변수에 추가하여 Y변수를 예측하기 위한 분석 데이터로 활용하였습니다. FA 결과 Factor1은 대표자 주변의 인프라(학부, 학력), Factor2는 대표자의 사교적 성격(인맥), Factor3은 
