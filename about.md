...
학부 졸업 후 LG CNS의 인턴십을 진행하며, U+ TV 시청 기록 로그를 바탕으로 Insight를 발굴하고 이를 tableau를 이용해 시각화하여 프레젠테이션하였고, \<가상화폐 자동 트레이딩 머신\> 개인 프로젝트를 진행하면서 파이썬 개발 능력을 길렀습니다. 또한 통합 평생교육 플랫폼 구축 프로젝트의 분석 파트에 참여해 분석 주제에 대한 수행 방안을 설계하였습니다.
